          ...
          <TableBody>
            {
              ...
              songData.map(sd => <TableRow key={sd.song_id}>
                <TableCell key='#'>{sd.number}</TableCell>
                <TableCell key='Title'>
                  <Link onClick={() => setSelectedSongId(sd.song_id)}>
                    {sd.title}
                  </Link>
                </TableCell>
                <TableCell key='Plays'>{sd.plays}</TableCell>
                <TableCell key='Duration'>{formatDuration(sd.duration)}</TableCell>
              </TableRow>
            )}
          </TableBody>
        </Table>
